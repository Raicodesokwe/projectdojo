...
import 'package:projectdojo/equity/equitysample.dart';
import 'package:projectdojo/services/investtoggle.dart';

class EquityInvestments extends StatefulWidget {
  @override
  _EquityInvestmentsState createState() => _EquityInvestmentsState();
}

class _EquityInvestmentsState extends State<EquityInvestments> {
  int _toggleValue = 0;
  @override
                  ...
                  child: Column(
                    children: [
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => HomeSliverChallenge()));
                    },
                          child: Card(
